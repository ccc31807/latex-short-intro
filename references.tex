...
\end{document}le
    ...
    Any paper of a reasonable size should have an index. Fortunately, indices in \LaTeXe{} are easy if a bit tedious. The tedious part comes from marking all the words to be indexed. The rest is pretty easy.
