...
\end{document}    
        ...
        \lstset{language=[LaTeX]TeX,numbers=right,keywordstyle=\color{blue}\textbf,keepspaces=true,basicstyle=\footnotesize,numberstyle=\scriptsize,showstringspaces=false,breaklines=true,commentstyle=\color{green}}
\begin{lstlisting}
\documentclass{article}
