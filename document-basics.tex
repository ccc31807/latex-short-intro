...
\end{document}    
        ...
        \paragraph{Exercise:}\Lx{} has a number of different document classes. Name four of them.
...
\end{document}    
        ...
        \paragraph{Exercise:}As with much else in \Lx,there are multiple ways to italisize or bold-face text. Can you find other ways?
